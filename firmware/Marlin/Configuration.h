...
#define STRING_CONFIG_H_AUTHOR "Eneko Montero" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "http://haudahau.com/vadedos"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "nkom printrbot"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Printrbot nkom
  #define DEFAULT_Kp 55.14
  #define DEFAULT_Ki 6.01
  #define DEFAULT_Kd 126.47
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80,80,2560,854.6789 }
